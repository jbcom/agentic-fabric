# Continuous Work Directive — agentic-fabric

**Status:** RELEASED
**Owner:** Claude

(No active work queue yet. When ready to begin a continuous work session,
flip Status to ACTIVE and add sections + items below.)
