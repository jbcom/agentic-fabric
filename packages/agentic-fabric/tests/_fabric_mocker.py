...
class FabricMocker:
    ...
    methods for mocking AI framework components commonly used in agentic-fabric.
    ...
    # =========================================================================
    # agentic-fabric Internal Mocking
    # =========================================================================
